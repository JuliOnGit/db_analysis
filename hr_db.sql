--------------------------------------------------------
--  File created - Wednesday-April-12-2023   
--------------------------------------------------------
--------------------------------------------------------
...
;
--------------------------------------------------------
--  DDL for View TABLE_COLUMN_ROW_COUNTS
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "HR"."TABLE_COLUMN_ROW_COUNTS" ("TABLE_NAME", "NUMBER_OF_COLUMNS", "NUM_ROWS") DEFAULT COLLATION "USING_NLS_COMP"  AS 
  SELECT t.TABLE_NAME, c.NUMBER_OF_COLUMNS, r.NUM_ROWS
FROM ALL_TABLES t, ALL_TAB_STATISTICS r, (
  SELECT s.TABLE_NAME, COUNT(*) NUMBER_OF_COLUMNS
